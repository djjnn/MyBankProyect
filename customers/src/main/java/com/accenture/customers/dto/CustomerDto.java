...
public class CustomerDto {
    ...
    @Size(min= 3, max=80, message = "El nombre debe contener entre 3 y 80 caracteres de longitud")
    private String name;
    ...
    @Size(min= 20, max=150, message = "El direccion debe contener entre 20 y 150 caracteres de longitud")
